                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"><h4>Data Pelanggan</h4></li>
                        </ol>
                        <div class="row">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <button type="button" class="btn btn-warning mb-4"  data-toggle="modal" data-target="#edit<?=$idpl;?>">Edit
                                                 </button> 
                                                 <button type="button" class="btn btn-danger mb-4"  data-toggle="modal" data-target="#hapus<?=$idpl;?>">Hapus
                                                 </button> 
                                            </td>
                                        </tr> 
                                          ...
                                          <div class="modal fade" id="edit<?=$idpl;?>">
                                            <div class="modal-dialog">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <!-- Modal body -->
                                                        <div class="modal-body">
                                                            <input type="text" name="namapelanggan" class="form-control" placeholder="Edit Nama Pelanggan" value="<?=$namapelanggan;?>">
                                                            <br>
                                                            <input type="text" name="notlp" class="form-control" placeholder="Edit nomor telfon" value="<?=$notlp;?>">
                                                            <br>
                                                            <input type="text" name="alamat" class="form-control" placeholder="Edit alamat produk" value="<?=$alamat;?>">
                                              ...
                                              <!-- Modal Edit -->
                                          <div class="modal fade" id="hapus<?=$idpl;?>">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <!-- Modal body -->
                                                     <div class="modal-body">
                                                      <font color="red">Apakah Anda Yakin Menghapus Pelanggan Ini?</font>
                                                        <input type="hidden" name="idpl" value="<?=$idpl;?>">
                                                     </div>
                                                        <!-- Modal footer -->
                                                         <div class="modal-footer">
