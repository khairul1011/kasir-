                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$tanggal;?></td>
                                            <td align="center">
                                                <button type="button" class="btn btn-warning mb-4"  data-toggle="modal" data-target="#edit<?=$idmasuk;?>">Edit
                                                </button> 
                                                <button type="button" class="btn btn-danger mb-4"  data-toggle="modal" data-target="#hapus<?=$idmasuk;?>">Delete
                                                </button> 
                                            </td>
                                        </tr> 
                                         <!-- Modal Edit -->
                                          <div class="modal fade" id="edit<?=$idmasuk;?>">
                                            <div class="modal-dialog">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <!-- Modal body -->
                                                        <div class="modal-body">
                                                            <input type="text" name="namaproduk" class="form-control" placeholder="Nama produk" disabled value="<?=$namaproduk;?>">
                                                            <br>
                                                            <input type="number" name="qty" class="form-control" placeholder="Edit jumlah produk" value="<?=$qty;?>">
                                              ...
                                              <!-- Modal Edit -->
                                          <div class="modal fade" id="hapus<?=$idmasuk;?>">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
